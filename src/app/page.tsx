      ...
      <header className="py-6 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-full bg-gradient-to-tr from-primary to-secondary p-[2px]">
            <Avatar className="w-full h-full border-2 border-background">
              ...
              <AvatarFallback className="bg-muted text-primary text-xs font-black">{user.username.substring(0,2).toUpperCase()}</AvatarFallback>
            </Avatar>
          </div>
          <div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-9 h-9 rounded-xl glass-morphism flex items-center justify-center relative border-white/10 hover:bg-white/10 transition-colors cursor-pointer">
            ...
            <div className="absolute top-2 right-2 w-2 h-2 bg-secondary rounded-full animate-pulse shadow-[0_0_8px_rgba(57,255,20,0.8)]" />
          </div>
        </div>
      </header>
